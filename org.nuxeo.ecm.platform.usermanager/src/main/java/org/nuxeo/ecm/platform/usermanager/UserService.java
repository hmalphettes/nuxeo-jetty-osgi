...
public class UserService extends DefaultComponent {
    ...
    protected void recomputeUserManager(boolean lazy) throws ClientException {
        ...
        System.err.println(merged.getClass().getClassLoader());
        System.err.println(merged.getClass().getClassLoader().getParent());
        System.err.println(merged.getClass().getClassLoader().getParent().getParent());
        //merged.setUserListingMode("search_only");
